...
export default function DashboardPage() {
  ...
  const MetricCard = ({ label, value, sub }) => (
    ...
    >
      <div
        style={{ fontSize: 11, fontFamily: 'var(--mono)', color: 'var(--text-3)', marginBottom: 4 }}
      >
        {label}
      </div>
      <div
            ...
            {data.recent_jobs.length > 0 && (
              ...
              >
                ...
                {data.recent_jobs.map((j) => (
                  ...
                  >
                    <span
                      style={{ fontFamily: 'var(--mono)', fontSize: 11, color: 'var(--text-2)' }}
                    >
                      {j.job_id.slice(0, 8)}
                    </span>
                    <span
                      style={{ color: j.status === 'success' ? 'var(--green)' : 'var(--text-3)' }}
                    >
                      {j.status}
                    </span>
