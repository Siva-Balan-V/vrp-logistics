      ...
      {vehicles.map((v, i) => {
        ...
        return (
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' || e.key === ' ') onSelect(isSelected ? null : v.vehicle_id)
            }}
            style={{
                  ...
                  {v.waypoints.map((wp, wi) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          style={{
                            color: isDepot ? 'var(--accent)' : 'var(--text-3)',
                            width: 14,
                            flexShrink: 0,
                          }}
                        >
...
function Metric({ label, value }) {
  return (
    <div>
      <div
        style={{ fontSize: 12, fontFamily: 'var(--mono)', color: 'var(--text)', fontWeight: 500 }}
      >
        {value}
      </div>
