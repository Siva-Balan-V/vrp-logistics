...
> Status: complete — all items 8.1–8.8 implemented, tested, and committed on
> `feat/live-dispatch`. Full backend + frontend suites green.
...
### 8.8 Accessibility pass (improvement item 37) — Medium ✅ Done
